...
class GeneralEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set COINGECKO_TEST_GENERAL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function general_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("COINGECKO_TEST_GENERAL_ENTID");
