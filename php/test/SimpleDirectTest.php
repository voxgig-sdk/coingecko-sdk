...
class SimpleDirectTest extends TestCase
{
    public function test_direct_load_simple(): void
    {
        $setup = simple_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-simple", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
