...
// Coingecko SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CoingeckoSDK::test)
...
{
    private const SDK_CLASS = 'CoingeckoSDK';
    ...
    private const SDK_BASE = 'coingecko_sdk';
