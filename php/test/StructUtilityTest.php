...
// Coingecko SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CoingeckoOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CoingeckoOmni::structfix($now, Struct::undef()))
                        !== json_encode(CoingeckoOmni::structfix($val, Struct::undef()))) {
