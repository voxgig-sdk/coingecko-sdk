...
class CoingeckoTestRunner
{
    ...
    {
        $live = self::getenv('COINGECKO_TEST_LIVE');
        $override = self::getenv('COINGECKO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('COINGECKO_TEST_EXPLAIN');
...
class_alias('CoingeckoTestRunner', 'Runner');
class_alias('CoingeckoHelpers', 'Helpers');
