...
class CoingeckoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CoingeckoSDK/1.0)';
    ...
    public static function call(CoingeckoContext $ctx, string $fullurl, array $fetchdef): array
    {
