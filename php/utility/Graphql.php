...
class CoingeckoGraphql
{
    ...
    // equivalent.
    public static function body(CoingeckoContext $ctx): mixed
    {
    ...
    public static function errors(CoingeckoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
