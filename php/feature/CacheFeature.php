...
class CoingeckoCacheFeature extends CoingeckoBaseFeature
{
    ...
    private function _through(CoingeckoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
