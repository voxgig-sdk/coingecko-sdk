...
class CoingeckoProxyFeature extends CoingeckoBaseFeature
{
    ...
    public function init(CoingeckoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CoingeckoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
