...
// Coingecko SDK clienttrack feature
...
class CoingeckoClienttrackFeature extends CoingeckoBaseFeature
{
    ...
    public function PostConstruct(CoingeckoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Coingecko-SDK';
