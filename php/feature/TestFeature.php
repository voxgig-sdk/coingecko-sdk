...
// Coingecko SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CoingeckoTestFeature extends CoingeckoBaseFeature
{
    ...
    public function init(CoingeckoContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CoingeckoContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CoingeckoParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CoingeckoContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CoingeckoContext $ctx, $op, $args): array
    {
