...
// Coingecko SDK streaming feature
...
class CoingeckoStreamingFeature extends CoingeckoBaseFeature
{
    ...
    private function _iterate(CoingeckoResult $result): \Generator
    {
    ...
    private function _streamable(CoingeckoContext $ctx): bool
    {
