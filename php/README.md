...
The PHP SDK for the Coingecko API — an entity-oriented client using PHP conventions.
...
```php
require_once 'coingecko_sdk.php';
$client = new CoingeckoSDK($options);
```
...
The main class (`coingecko_sdk.php`) exports the SDK class
