...
The PHP SDK for the Coingecko API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->General(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Coingecko(null)->load(
    ["id" => "test01"], null
);
