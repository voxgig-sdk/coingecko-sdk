...
describe("SimpleEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set COINGECKO_TEST_SIMPLE_ENTID JSON to run live")
      return
    end
...
function simple_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("COINGECKO_TEST_SIMPLE_ENTID")
