...
describe("SimpleDirect", function()
  it("should direct-load-simple", function()
    local setup = simple_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-simple", setup.live and "live" or "unit")
...
function simple_direct_setup(mockres)
  ...
  local live = env["COINGECKO_TEST_LIVE"] == "TRUE"
