...
function envOverride(m) {
    if ('TRUE' === process.env.COINGECKO_TEST_LIVE ||
        'TRUE' === process.env.COINGECKO_TEST_OVERRIDE) {
    ...
    m.COINGECKO_TEST_EXPLAIN = process.env.COINGECKO_TEST_EXPLAIN || m.COINGECKO_TEST_EXPLAIN;
    return m;
}
