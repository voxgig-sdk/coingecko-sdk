...
(0, node_test_1.describe)('SimpleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CoingeckoSDK({
    ...
    (0, node_test_1.test)('direct-load-simple', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-simple', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.COINGECKO_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CoingeckoSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.COINGECKO_APIKEY,
        }));
        let idmap = env['COINGECKO_TEST_SIMPLE_ENTID'];
    ...
    const client = new __1.CoingeckoSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SimpleDirect.test.js.map