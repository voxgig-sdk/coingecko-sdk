...
type Args struct {
	Entity string         `json:"entity" jsonschema:"general | simple"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CoingeckoSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "coingecko_list",
		Description: "List records from Coingecko. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "coingecko_load",
		Description: "Load a single record from Coingecko. " +
...
func runOp(client *sdk.CoingeckoSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CoingeckoSDK, name string) (sdk.CoingeckoEntity, error) {
	switch strings.ToLower(name) {
	case "general":
		return client.General(nil), nil
	case "simple":
		return client.Simple(nil), nil
