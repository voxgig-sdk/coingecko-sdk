...
func NewSimpleEntity(client *core.CoingeckoSDK, entopts map[string]any) *SimpleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SimpleEntity) GetName() string { return e.name }
...
func (e *SimpleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SimpleEntity) Deleted() bool {
	return e.deleted
}


func (e *SimpleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSimpleEntity(e.client, opts)
}

func (e *SimpleEntity) Data(args ...any) any {
...
func (e *SimpleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Simple; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SimpleEntity) DataTyped(data ...Simple) Simple {
	if len(data) > 0 {
		return typedFrom[Simple](e.Data(asMap(data[0])))
	}
	return typedFrom[Simple](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Simple (all fields
// optional at the wire level).
func (e *SimpleEntity) MatchTyped(match ...Simple) Simple {
	if len(match) > 0 {
		return typedFrom[Simple](e.Match(asMap(match[0])))
	}
	return typedFrom[Simple](e.Match())
}
...
func (e *SimpleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SimpleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SimpleLoadMatch and returns an Simple. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SimpleEntity) LoadTyped(reqmatch SimpleLoadMatch, ctrl map[string]any) (Simple, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Simple{}, err
	}
	return typedFrom[Simple](res), nil
}



func (e *SimpleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SimpleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SimpleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SimpleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SimpleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
