...
const testSeed = `map[string]any{"entity": map[string]any{"general": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "simple": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
