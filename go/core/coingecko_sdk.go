...
func (sdk *CoingeckoSDK) OptionsMap() map[string]any {
...
func (sdk *CoingeckoSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CoingeckoSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CoingeckoSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CoingeckoSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CoingeckoSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CoingeckoSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CoingeckoSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CoingeckoSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CoingeckoSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CoingeckoSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
