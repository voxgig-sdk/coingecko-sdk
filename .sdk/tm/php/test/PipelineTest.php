...
{
    private static function utility(): CoingeckoUtility
    {
        return new CoingeckoUtility();
    }
    ...
    private static function ctx(array $over = []): CoingeckoContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CoingeckoContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CoingeckoOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CoingeckoError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CoingeckoOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CoingeckoMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CoingeckoOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CoingeckoMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CoingeckoOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CoingeckoMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CoingeckoSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CoingeckoMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CoingeckoResponse([]),
            'result' => new CoingeckoResult([]),
        ]);
        [, $err] = CoingeckoMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CoingeckoSpec([]),
            'response' => null,
            'result' => new CoingeckoResult([]),
        ]);
        [, $err] = CoingeckoMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CoingeckoSpec(['step' => 's']),
            'response' => new CoingeckoResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CoingeckoResult([]),
        ]);
        [, $err] = CoingeckoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CoingeckoSpec(['step' => 's']),
            'response' => new CoingeckoResponse(self::resp(200, ['v' => 1])),
            'result' => new CoingeckoResult([]),
        ]);
        [, $err] = CoingeckoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CoingeckoSpec(['step' => 's']),
            'response' => new CoingeckoResponse(self::resp(200, ['v' => 2])),
            'result' => new CoingeckoResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CoingeckoMakeResponse::call($ctx);
    ...
    {
        $preset = new CoingeckoResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CoingeckoSpec([]),
            'response' => new CoingeckoResponse([]),
            'result' => new CoingeckoResult([]),
        ...
        [$got, $err] = CoingeckoMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CoingeckoResult([])]);
        [, $err] = CoingeckoMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CoingeckoSpec([]), 'result' => null]);
        [, $err] = CoingeckoMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CoingeckoSpec(['step' => 's']),
            'result' => new CoingeckoResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CoingeckoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CoingeckoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CoingeckoSpec(['step' => 's']),
            'result' => new CoingeckoResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CoingeckoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CoingeckoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CoingeckoResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CoingeckoSpec([]),
            'result' => new CoingeckoResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CoingeckoMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CoingeckoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CoingeckoError('boom', 'boom');
        $utility->fetcher = function (CoingeckoContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CoingeckoSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CoingeckoMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CoingeckoContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CoingeckoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CoingeckoResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CoingeckoContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CoingeckoSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CoingeckoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CoingeckoResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CoingeckoSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CoingeckoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CoingeckoMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CoingeckoMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CoingeckoResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CoingeckoDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CoingeckoResult(['ok' => false])]);
        $this->expectException(CoingeckoError::class);
        CoingeckoDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CoingeckoResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CoingeckoMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CoingeckoMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CoingeckoBaseFeature();
        $b = new CoingeckoBaseFeature();
        CoingeckoFeatureAdd::call($ctx, $a);
        CoingeckoFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CoingeckoBaseFeature
    {
        $f = new CoingeckoBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CoingeckoFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CoingeckoContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CoingeckoSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CoingeckoPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CoingeckoResponse(['headers' => null]),
            'result' => new CoingeckoResult([]),
        ]);
        CoingeckoResultHeaders::call($ctx);
