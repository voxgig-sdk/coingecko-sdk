...
class CoingeckoRbacFeature extends CoingeckoBaseFeature
{
    ...
    private function _required(CoingeckoContext $ctx): ?string
    {
    ...
    private function _reject(CoingeckoContext $ctx, string $required): void
    {
    ...
    private function _track(CoingeckoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
