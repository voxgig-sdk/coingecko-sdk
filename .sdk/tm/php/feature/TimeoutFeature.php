...
class CoingeckoTimeoutFeature extends CoingeckoBaseFeature
{
    ...
    private function _with_timeout(CoingeckoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CoingeckoContext $_ctx, float $ms): void
    {
        $client = $this->client;
