...
// Coingecko SDK ratelimit feature
...
class CoingeckoRatelimitFeature extends CoingeckoBaseFeature
{
    ...
    private function _acquire(CoingeckoContext $ctx): void
    {
    ...
    private function _track(CoingeckoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
