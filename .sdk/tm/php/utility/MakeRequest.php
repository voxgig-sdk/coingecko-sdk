...
// Coingecko SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CoingeckoMakeRequest
{
    public static function call(CoingeckoContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CoingeckoResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CoingeckoResponse($fetched);
        } else {
