...
|---|---|---|
| `ts/` | @voxgig-sdk/coingecko-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/coingecko-sdk \
      --repository voxgig-sdk/coingecko-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/coingecko-sdk` shows it, and
`npm trust revoke @voxgig-sdk/coingecko-sdk --id=<id>` removes it.
