...
module CoingeckoTestRunner
  ...
  def self.env_override(m)
    live = getenv("COINGECKO_TEST_LIVE")
    override = getenv("COINGECKO_TEST_OVERRIDE")
    ...
    explain = getenv("COINGECKO_TEST_EXPLAIN")
    m["COINGECKO_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CoingeckoTestRunner
Helpers = CoingeckoHelpers
Vs = VoxgigStruct
