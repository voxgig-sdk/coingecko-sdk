...
AQL-driven CLI and REPL for the Coingecko SDK. Positional arguments are
...
./coingecko-cli list general
./coingecko-cli load 1 general
./coingecko-cli load '{id:1}' general
