...
func registerSDKWords(r *eng.Registry, client *sdk.CoingeckoSDK) {
...
func runOp(client *sdk.CoingeckoSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
