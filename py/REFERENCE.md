# Coingecko Python SDK Reference

Complete API reference for the Coingecko Python SDK.
...
#### `CoingeckoSDK.test(testopts=None, sdkopts=None)`
...
```python
result = client.Simple().load({"ids": "ids", "vs_currency": "vs_currency"})
```
