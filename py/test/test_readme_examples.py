# Coingecko SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CoingeckoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CoingeckoSDK(...) and CoingeckoSDK.test(...) become
#      CoingeckoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "coingecko_sdk"
_SDK_CLASS = "CoingeckoSDK"
