...
from coingecko_sdk.core.helpers import get_ctx_prop, to_map
...
class CoingeckoContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, CoingeckoSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CoingeckoResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CoingeckoResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CoingeckoError(code, msg, self)
