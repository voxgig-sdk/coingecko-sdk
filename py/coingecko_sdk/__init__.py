...
from coingecko_sdk.utility import register

# Load features
from coingecko_sdk.feature.base_feature import CoingeckoBaseFeature
from coingecko_sdk.features import _has_feature, _make_feature
...
class CoingeckoSDK:
    ...
    def get_utility(self):
        return CoingeckoUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CoingeckoSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def General(self, data=None) -> "GeneralEntity":
        ...
        from coingecko_sdk.entity.general_entity import GeneralEntity
    ...
    def Simple(self, data=None) -> "SimpleEntity":
        ...
        from coingecko_sdk.entity.simple_entity import SimpleEntity
